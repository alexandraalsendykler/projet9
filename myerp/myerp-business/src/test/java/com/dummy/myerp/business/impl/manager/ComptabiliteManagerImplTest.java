...
public class ComptabiliteManagerImplTest {
	...
	public void checkEcritureComptableUnitRG5Code() throws Exception {
		...
		EcritureComptable vEcritureComptable;
		vEcritureComptable = new EcritureComptable();
		vEcritureComptable.setJournal(new JournalComptable("BQ", "Journal de banque"));
		Date today = new Date();
		vEcritureComptable.setDate(today);
		vEcritureComptable.setLibelle("Libelle");
		String year = new SimpleDateFormat("yyyy").format(today);
		vEcritureComptable.setReference("AB-" + year + "/00003");
		vEcritureComptable.getListLigneEcriture()
				.add(new LigneEcritureComptable(new CompteComptable(1), null, new BigDecimal(123), null));
		vEcritureComptable.getListLigneEcriture()
				.add(new LigneEcritureComptable(new CompteComptable(2), null, null, new BigDecimal(1234)));
	...
	public void checkEcritureComptableUnitRG5Annee() throws Exception {
		...
		vEcritureComptable.setLibelle("Libelle");
		String year = "2019";
		vEcritureComptable.setReference("BQ-" + year + "/00003");
		vEcritureComptable.getListLigneEcriture()
				.add(new LigneEcritureComptable(new CompteComptable(1), null, new BigDecimal(123), null));
		vEcritureComptable.getListLigneEcriture()
				.add(new LigneEcritureComptable(new CompteComptable(2), null, null, new BigDecimal(1234)));
